...
# dataset
parser.add_argument('--train_dataset_list', type=str, default='random_42')
parser.add_argument('--valid_dataset_list', type=str, default='random_42')
parser.add_argument('--test_dataset_list', default='random_42')
...
# others
parser.add_argument('--data_path', type=str, default='/data/zhaojingtong/PrimeKG/KGPrompt/random_42/processed_data/KGPrompt')
