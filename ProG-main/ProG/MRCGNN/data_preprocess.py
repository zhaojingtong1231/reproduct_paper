...
def load_data(args, val_ratio=0.1, test_ratio=0.2):
    ...
    drug_list = []
    with open('/project/reproduct_paper/ProG-main/ProG/MRCGNN/small_data/drug_listxiao.csv', 'r') as f:
        reader = csv.reader(f)
        for row in reader:
    ...
    def loadtrainvaltest():
        #train dataset
        train=pd.read_csv('/project/reproduct_paper/ProG-main/ProG/MRCGNN/small_data/'+str(zhongzi)+'/ddi_training1xiao.csv')
        ...
        #val dataset
        val = pd.read_csv('/project/reproduct_paper/ProG-main/ProG/MRCGNN/small_data/'+str(zhongzi)+'/ddi_validation1xiao.csv')
        ...
        #test dataset
        test = pd.read_csv('/project/reproduct_paper/ProG-main/ProG/MRCGNN/small_data/'+str(zhongzi)+'/ddi_test1xiao.csv')
    ...
    features = np.load('/project/reproduct_paper/ProG-main/ProG/MRCGNN/trimnet_small/drug_emb_trimnet'+str(zhongzi)+'.npy')
    ids = np.load('/project/reproduct_paper/ProG-main/ProG/MRCGNN/trimnet_small/drug_idsxiao.npy')
    ids=ids.tolist()
    features1=[]
    ...
    # data_o = Data(x=x_o, y = y_o,edge_index=edge_index_o.t().contiguous(), edge_type=label_list)
    data_o = Data(x=x_o, y = y_o,edge_index=edge_index_o.t(), edge_type=label_list)
