...
import torch
import numpy as np
from .MRCGNN.data_preprocess import load_data
from .MRCGNN.parms_setting import settings
...
def myload_data4pretrain(dataname='DDi', num_parts=50):
    # small_data = pk.load(open('./Dataset/{}/feature_reduced.small_data'.format(dataname), 'br'))
