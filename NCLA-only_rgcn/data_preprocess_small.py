...
def load_small_data(zhongzi,batch,workers):
    ...
    def loadtrainvaltest():
        #train dataset
        train=pd.read_csv('small_data/'+str(zhongzi)+'/ddi_training1xiao.csv')
        ...
        #val dataset
        val = pd.read_csv('small_data/'+str(zhongzi)+'/ddi_validation1xiao.csv')
        ...
        #test dataset
        test = pd.read_csv('small_data/'+str(zhongzi)+'/ddi_test1xiao.csv')
    ...
    features = np.load('trimnet_small/drug_emb_trimnet'+str(zhongzi)+'.npy')
    # features = np.load('/project/reproduct_paper/NCLA-main/MRCGNN_code/drug_emb_trimnet'+str(zhongzi)+'.npy')
    ids = np.load('trimnet_small/drug_idsxiao.npy')
    ids=ids.tolist()
    features1=[]
