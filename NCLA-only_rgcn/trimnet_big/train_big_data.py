...
parser.add_argument('--gpu', type=int, default=0, help='gpu ids')
...
###### Dataset
df_ddi_train = pd.read_csv('big_data/' + str(zhongzi) + '/ddi_training1.csv')
df_ddi_val = pd.read_csv('big_data/' + str(zhongzi) + '/ddi_validation1.csv')
df_ddi_test = pd.read_csv('big_data/' + str(zhongzi) + '/ddi_test1.csv')
...
save_path = os.path.join(save_dir,
                             f"big_zhongzi{zhongzi}_time_{time_str}")
