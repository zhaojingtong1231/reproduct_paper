...
def evaluate_graph_construct(df_valid, data, neg_sampler, k,hidden_dim):
    edge_dict = {}
    ...
    g_valid = process.initialize_node_embedding(g_valid, hidden_dim)
    # Negative sampling
...
class PreData:
    ...
    def prepare_split(self, split='complex_disease',
        ...
        g_valid_pos , g_valid_neg = evaluate_graph_construct(df_test,g,'fix_dst', 1,hidden_dim = hidden_dim)
