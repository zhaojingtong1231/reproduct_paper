...
class MRCGNN(nn.Module):
    def __init__(self, feature, hidden1, hidden2, decoder1, dropout,zhongzi):
        ...
        self.encoder_o1 = RGCNConv(feature, hidden1,num_relations=86)
        self.encoder_o2 = RGCNConv(hidden1 , hidden2,num_relations=86)
        ...
        self.mlp = nn.ModuleList([nn.Linear(194, 256),
                                  nn.ELU(),
                                  nn.Dropout(p=0.1),
                                  nn.Linear(256, 128),
                                  nn.ELU(),
