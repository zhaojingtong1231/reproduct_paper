...
def load_data(args, val_ratio=0.1, test_ratio=0.2):
    ...
    def loadtrainvaltest():
        #train dataset
        train=pd.read_csv("../Ryu's dataset"+str(zhongzi)+'/ddi_training1.csv')
        ...
        #val dataset
        val = pd.read_csv("../Ryu's dataset"+str(zhongzi)+'/ddi_validation1.csv')
        ...
        #test dataset
        test = pd.read_csv("../Ryu's dataset"+str(zhongzi)+'/ddi_test1.csv')
