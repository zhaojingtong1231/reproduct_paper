...
if __name__ == '__main__':
    # file_path = '/project/reproduct_paper/SEMG-MIGNN/standardization/0_xtbopt.xyz'
    directory_path = './our1_xtb_xyz_std/'
    ...
    for item in files_and_directories:
        ...
        try:
            cal_dm(df_name='b3lyp', basis='def2-svp', tem_file=file_path, file_dir='./out/', grid_num=7)
        except:
            print('失败：'+item)
            lose_file.append(item)
            pass
    csv_file_path = "./output.csv"
    with open(csv_file_path, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerows(lose_file)