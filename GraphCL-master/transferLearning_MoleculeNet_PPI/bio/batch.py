...
class BatchFinetune(Data):
    ...
    (dicconnected) graph. With :class:`torch_geometric.small_data.Data` being the
    ...
    def from_data_list(data_list):
        ...
        :class:`torch_geometric.small_data.Data` objects.
...
class BatchMasking(Data):
    ...
    def cumsum(self, key, item):
        ...
        .. note::
            ...
            if the batch concatenation process is corrupted for a specific small_data
            attribute.
        """
...
class BatchSubstructContext(Data):
    ...
    def from_data_list(data_list):
        ...
        :class:`torch_geometric.small_data.Data` objects.
        The assignment vector :obj:`batch` is created on the fly."""
        #keys = [set(small_data.keys) for small_data in data_list]
        #keys = list(set.union(*keys))
        #assert 'batch' not in keys
