...
class DataLoaderFinetune(torch.utils.data.DataLoader):
    r"""Data loader which merges small_data objects from a
    :class:`torch_geometric.small_data.dataset` to a mini-batch.
    Args:
        dataset (Dataset): The dataset from which to load the small_data.
        batch_size (int, optional): How may samples per batch to load.
            (default: :obj:`1`)
        shuffle (bool, optional): If set to :obj:`True`, the small_data will be
