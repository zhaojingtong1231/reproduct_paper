...
class MaskEdge:
    ...
    def __call__(self, data, masked_edge_indices=None):
        ...
        :return: None, creates new attributes in the original small_data object:
        small_data.mask_edge_idx: indices of masked edges
        small_data.mask_edge_labels: corresponding ground truth edge feature for
        each masked edge
        small_data.edge_attr: modified in place: the edge features (
...
class ExtractSubstructureContextPair:
    ...
    def __call__(self, data, root_idx=None):
        ...
        if len(context_node_idxes) > 0:
            ...
            # reset node idx to 0 -> num_nodes - 1, other small_data obj does not
            # make sense
