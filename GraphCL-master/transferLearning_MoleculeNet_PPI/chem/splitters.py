...
def scaffold_split(dataset, smiles_list, task_idx=None, null_value=0,
    ...
    :param task_idx: column idx of the small_data.y tensor. Will filter out
    examples with null value in specified task column of the small_data.y tensor
    prior to splitting. If None, then no filtering
    :param null_value: float that specifies null value in small_data.y to filter if
