...
class SuperPixDatasetDGL(torch.utils.data.Dataset):
    def __init__(self, name, num_val=5000):
        ...
        use_coord = True
        self.test = SuperPixDGL("./small_data/superpixels", dataset=self.name, split='test',
                            use_mean_px=use_mean_px, 
                            use_coord=use_coord)

        self.train_ = SuperPixDGL("./small_data/superpixels", dataset=self.name, split='train',
                             use_mean_px=use_mean_px, 
                             use_coord=use_coord)
...
class SuperPixDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, name):
        ...
        self.name = name
        data_dir = 'small_data/superpixels/'
    ...
    def format_dataset(self, dataset):  
        """
            Utility function to recover small_data,
