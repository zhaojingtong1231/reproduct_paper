...
cmd_opt.add_argument('-data_folder', type=str, default=None, help='small_data folder')
...
# for AT-SimGRACE
cmd_opt.add_argument('-lr_inner', type=float, default=0.001, help='lr of inner opt')
cmd_opt.add_argument('-epison', type=float, default=0.01, help='radius of perturbation ball')
cmd_opt.add_argument('--clip_norm', type=int, default=50, help='Maximum norm of parameter gradient.')
# for attack 
