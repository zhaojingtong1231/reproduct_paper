...
def mol_to_graph_data_obj_simple(mol):
    ...
    :return: graph small_data object with the attributes: x, edge_index, edge_attr
    """
    # atoms
...
def graph_data_obj_to_mol_simple(data_x, data_edge_index, data_edge_attr):
    """
    Convert pytorch geometric small_data obj to rdkit mol object. NB: Uses simplified
...
def graph_data_obj_to_nx_simple(data):
    ...
    network x small_data object. NB: Uses simplified atom and bond features,
    ...
    def get(self, idx):
        ...
        if self.aug == 'dropN':
            ...
            if n == 0:
                ...
                data = subgraph(data, self.aug_ratio)
                # small_data = subgraph(small_data, 0.5)
            else:
...
class MoleculeFingerprintDataset(data.Dataset):
    ...
    def _process(self):
        ...
        # save processed small_data objects and smiles
