...
parser.add_argument('--data_root', type=str, default="small_data")
...
parser.add_argument('--dataset', type=str, default="RDT-M5K")
...
# os.mkdir("logs_simgrace_eta_"+str(args.eta)+"/")
model_PATH = "../pre-training/models_simgrace_eta_"+str(args.eta)+"/" + args.dataset + "_" + args.aug1 + "_" + str(args.aug_ratio1) + "_" + args.aug2 + "_" + str(args.aug_ratio2) + "_" + args.model_epoch + "_" + args.model_lr + "_" + str(args.suffix) + ".pt"
log_PATH = "logs_simgrace_eta_"+str(args.eta)+"/" + args.model + "_" + args.dataset + "_log_" + str(args.semi_split) ###
...
def run_exp_lib(dataset_feat_net_triples,
    ...
    for exp_id, (dataset_name, feat_str, net) in enumerate(
        ...
        summary1 = 'small_data={}, model={}, feat={}, eval={}'.format(
