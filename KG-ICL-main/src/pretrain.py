...
# dataset
parser.add_argument('--train_dataset_list', type=str, default='PrimeKG')
parser.add_argument('--valid_dataset_list', type=str, default='PrimeKG')
parser.add_argument('--test_dataset_list', default='PrimeKG')
