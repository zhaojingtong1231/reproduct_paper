...
def load_data_statistics(all_tuples):
    ...
    '''
    print('Loading small_data statistics ...')
    statistics = dict()
    ...
    for h, t, r in tqdm(all_tuples, desc='Getting small_data statistics'):
    ...
    print('getting small_data statistics done!')
...
if __name__ == '__main__':
    ...
    dataset_file_name_map = {
        'drugbank': ('small_data/drugbank.tab', '\t'),
    ...
    args.dirname = 'small_data/preprocessed'
