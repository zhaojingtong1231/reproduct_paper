...
def load_ddi_dataset(root, batch_size, fold=0):
    ...
    train_loader = DrugDataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=6, drop_last=True)
    val_loader = DrugDataLoader(val_set, batch_size=batch_size, shuffle=False, num_workers=6)
    test_loader = DrugDataLoader(test_set, batch_size=batch_size, shuffle=False, num_workers=6)
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = load_ddi_dataset(root='small_data/preprocessed/drugbank', batch_size=256, fold=0)
